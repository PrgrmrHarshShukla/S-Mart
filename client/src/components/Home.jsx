...
function Home() {
  ...
  <div className="flex flex-col relative gap-28 bg-slate-300 w-11/12 z-1">
    ...
    <div className="flex justify-center mt-16">
      <img src="https://plus.unsplash.com/premium_photo-1670863088251-500151f2117b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1032&q=80" alt="Customers" className="w-screen h-96 object-contain z-0 mix-blend-darken" />
    </div>  
